                        ...
                        <div class="dropdown-menu custom-dropdown" aria-labelledby="dropdownMenuButton">
                            <form action="{{ route('admin.dashboard') }}" method="GET">
                                ...
                                <div>
                                    ...
                                    <label><input type="radio" name="status_filter" value="cancelled" {{ request('status_filter') == 'cancelled by user' ? 'checked' : '' }}> Cancelled by User</label>
                                    <label><input type="radio" name="status_filter" value="cancelled_no_show" {{ request('status_filter') == 'cancelled - no show' ? 'checked' : '' }}> Cancelled - No Show</label>
                                </div>
